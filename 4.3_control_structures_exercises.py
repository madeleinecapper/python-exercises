...
library = [
    ...
    {
        'title': 'Jims Guide to Jams',
        'author': 'JimJams',
        'genre': 'self-help'
    },
    {
        'title': 'Atlas Shrugged',
        'author': 'Objectivism Isntreal',
        'genre': 'fiction'
    },
    {
        'title': 'The Road',
        'author': 'Hardcastle Mcormick',
        'genre': 'sadness'
    },
    {
        'title': 'A Place to Go',
        'author': 'Diego von Traphouse',
        'genre': 'self-help'
    },
    {
        'title': 'Five Tings',
        'author': 'Fakey McPatois',
        'genre': 'fiction'
    },
    {
    ...
    {
        'title': 'Old Fashioned Jollops',
        'author': 'Henry of Henrys Old Fashioned Jollops',
        'genre': 'whalecore'
    }
]
